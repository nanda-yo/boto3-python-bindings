...
class ItemParams(BaseModel):
    var1: str = Field(..., example='String Var')  #I was thinking about making a linked list for pagination because i was forced to use aws, but i dont have time for that atm.
...
class ItemsFactory:
    ...
    def build(cls):
        ...
        #params = cls.generate_params()   #bugs out, no timme to fix, adding items to the list directly
        var1=Faker().isbn10()
